...
number_of_manufacturers <- length(unique(manufacturers))
...
made_in_1997 <- made_in_1997[order(made_in_1997$hwy),]

# Mutate the 1997 cars data frame to add a column `average` that has the average
# gas milage (between city and highway mpg) for each car
made_in_1997$average <- (made_in_1997$cty + made_in_1997$hwy) / 2
